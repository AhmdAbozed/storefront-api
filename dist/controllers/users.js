...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_1 = _a.sent();
                throw new Error("user creation error:".concat(err_1));
...
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_2 = _a.sent();
                throw new Error("users index error: ".concat(err_2));
            case 3: return [2 /*return*/];
        }
    });
}); };
var remove = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_3 = _a.sent();
                throw new Error("user deletion error:".concat(err_3));
            case 3: return [2 /*return*/];
        }
    });
}); };
var read = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_4 = _a.sent();
                throw new Error("user deletion error:".concat(err_4));
            case 3: return [2 /*return*/];
        }
    });
}); };
