...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                err_1 = _a.sent();
                throw new Error("order creation error:".concat(err_1));
            case 3: return [2 /*return*/];
        }
    });
}); };
var productsByOrder = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var product, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                err_2 = _a.sent();
                throw new Error("ordersByUser error:".concat(err_2));
            case 3: return [2 /*return*/];
        }
    });
}); };
